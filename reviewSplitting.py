...
csv_file_path = (
    "/Users/yasharya/FitSight-Produhacks2024/DATA/sentiment_reviews_withcount.csv"
)
...
additional_stopwords = [
    ...
    "like",
    "place",
]  # Example additional words to exclude


categorized_reviews, top_keywords = load_and_count_keywords_from_csv(
    csv_file_path, additional_stopwords
)
